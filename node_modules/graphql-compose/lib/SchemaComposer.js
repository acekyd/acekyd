...
class SchemaComposer extends _TypeStorage.TypeStorage {
  ...
  buildSchema(extraConfig) {
    ...
    const directives = [...this._directives, ...(extraConfig && Array.isArray(extraConfig.directives) ? [...extraConfig.directives] : [])]; // $FlowFixMe `description` was added only in graphql@15.0.0

    return new _graphql.GraphQLSchema(_objectSpread({
